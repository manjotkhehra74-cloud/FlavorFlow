...
class IndustryPack {
  ...
  static const Map<String, IndustryPack> _packs = {
    ...
    'footwear': IndustryPack(
      ...
      packingExamples: ['Shoe Box Size 8', 'Poly Bag', 'Tissue Paper', 'Size Sticker', 'Master Carton 12 pairs', 'Silica Gel 1gm'],
    ...
    'plastic': IndustryPack(
      id: 'plastic',
      packingCategories: ['Cartons', 'Poly Bags', 'Stretch Film', 'Pallets', 'Strapping', 'Labels', 'Bubble Wrap', 'Other'],
      packingExamples: ['Carton 500 pcs', 'Poly Bag 24×36', 'Stretch Film 23 mic', 'Wooden Pallet', 'PP Strap 12mm', 'Label'],
    ...
    'hardware': IndustryPack(
      id: 'hardware',
      packingCategories: ['Cartons', 'Corrugated Sheets', 'Poly Bags', 'Bubble Wrap', 'Pallets', 'Strapping', 'Labels', 'Other'],
      packingExamples: ['Carton 24 pcs', 'Corrugated Sheet', 'Poly Bag', 'Bubble Wrap Roll', 'Wooden Pallet', 'Steel Strap', 'Label'],
