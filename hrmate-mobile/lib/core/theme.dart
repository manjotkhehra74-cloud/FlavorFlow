...
/// HRMate design tokens — extracted from the live webapp (hr.flavorflow.co.in)
/// in Phase 7 so the native app is recognisably the same product: same colours,
/// same Inter typography, same card style, same navy punch card.
/// FROZEN after Phase 0, extended in Phase 7 (see ARCHITECTURE.md §4).
/// Every screen uses these; no feature file defines its own colours.
class HrBrand {
...
/// Light theme mirroring the webapp (Phase 7). Dark theme is Phase 7b —
/// the webapp itself defaults to light.
